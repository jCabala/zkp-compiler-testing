...
func (circuit *smtlib2_bool) Define(api frontend.API) error {
	...
	api.AssertIsEqual(api.And(api.And(api.And(api.And(api.Or(api.IsZero(circuit.FVar_scr1_x1), circuit.FVar_scr1_x2), api.Or(circuit.FVar_scr1_x1, api.IsZero(api.IsZero(api.Cmp(circuit.FVar_scr1_x2_scr2_x1_fused, circuit.FVar_scr2_x1))))), api.IsZero(circuit.FVar_scr1_x1)), api.Or(api.IsZero(api.Cmp(circuit.FVar_scr1_x2_scr2_x1_fused, circuit.FVar_scr2_x1)), api.IsZero(circuit.FVar_scr1_x1))), api.And(api.And(api.Or(api.IsZero(circuit.FVar_scr2_x2), circuit.FVar_scr2_x1), api.IsZero(api.IsZero(api.Cmp(circuit.FVar_scr1_x2_scr2_x1_fused, circuit.FVar_scr1_x2)))), api.IsZero(circuit.FVar_scr2_x2))), 1)
