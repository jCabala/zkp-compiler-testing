...
type smtlib2_bool struct {
	...
	FVar_scr1_x1_scr2_x1_fused frontend.Variable `gnark:",public"`
...
func (circuit *smtlib2_bool) Define(api frontend.API) error {
	...
	CircuitVarOut(circuit.FVar_scr1_x1_scr2_x1_fused)
	Label(circuit.FVar_scr1_x1_scr2_x1_fused, "scr1_x1_scr2_x1_fused")
	...
	api.AssertIsBoolean(circuit.FVar_scr1_x1_scr2_x1_fused)
	api.AssertIsBoolean(circuit.FVar_scr1_x2_scr2_x2_fused)
	api.AssertIsEqual(api.And(api.And(api.And(api.And(api.Or(api.IsZero(api.Cmp(circuit.FVar_scr1_x1_scr2_x1_fused, circuit.FVar_scr2_x1)), circuit.FVar_scr1_x2), api.Or(api.IsZero(api.IsZero(api.Cmp(circuit.FVar_scr1_x1_scr2_x1_fused, circuit.FVar_scr2_x1))), circuit.FVar_scr1_x2)), api.IsZero(api.Cmp(circuit.FVar_scr1_x1_scr2_x1_fused, circuit.FVar_scr2_x1))), api.Or(api.IsZero(circuit.FVar_scr1_x2), api.IsZero(api.Cmp(circuit.FVar_scr1_x1_scr2_x1_fused, circuit.FVar_scr2_x1)))), api.And(api.And(api.Or(api.IsZero(circuit.FVar_scr2_x2), circuit.FVar_scr2_x1), api.IsZero(api.IsZero(api.Cmp(circuit.FVar_scr1_x1_scr2_x1_fused, circuit.FVar_scr1_x1)))), api.IsZero(api.Cmp(circuit.FVar_scr1_x2_scr2_x2_fused, circuit.FVar_scr1_x2)))), 1)
	api.Println("scr1_x1_scr2_x1_fused:", circuit.FVar_scr1_x1_scr2_x1_fused)
