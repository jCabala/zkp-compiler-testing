...
func (circuit *smtlib2_bool) Define(api frontend.API) error {
	...
	api.AssertIsEqual(api.And(api.And(api.And(api.And(api.Or(api.IsZero(api.Cmp(circuit.FVar_scr1_x1_scr2_x2_fused, circuit.FVar_scr2_x2)), api.IsZero(api.IsZero(api.Cmp(circuit.FVar_scr1_x3_scr2_x3_fused, circuit.FVar_scr2_x3)))), api.IsZero(api.Cmp(circuit.FVar_scr1_x1_scr2_x2_fused, circuit.FVar_scr2_x2))), api.Or(circuit.FVar_scr1_x2, api.IsZero(api.IsZero(api.Cmp(circuit.FVar_scr1_x1_scr2_x2_fused, circuit.FVar_scr2_x2))))), api.Or(api.Or(api.IsZero(api.IsZero(api.Cmp(circuit.FVar_scr1_x1_scr2_x2_fused, circuit.FVar_scr2_x2))), api.IsZero(circuit.FVar_scr1_x2)), api.IsZero(api.IsZero(api.Cmp(circuit.FVar_scr1_x3_scr2_x3_fused, circuit.FVar_scr2_x3))))), api.And(api.And(api.And(api.And(api.And(api.And(api.Or(api.Or(api.IsZero(circuit.FVar_scr2_x1), circuit.FVar_scr2_x2), api.IsZero(circuit.FVar_scr2_x3)), api.Or(api.Or(circuit.FVar_scr2_x2, api.IsZero(circuit.FVar_scr2_x3)), circuit.FVar_scr2_x1)), api.IsZero(circuit.FVar_scr2_x3)), circuit.FVar_scr2_x2), api.Or(api.Or(api.IsZero(circuit.FVar_scr2_x2), circuit.FVar_scr2_x1), circuit.FVar_scr2_x3)), api.Or(circuit.FVar_scr2_x2, api.IsZero(circuit.FVar_scr2_x3))), api.Or(api.Or(api.IsZero(circuit.FVar_scr2_x3), circuit.FVar_scr2_x2), circuit.FVar_scr2_x1))), 1)
