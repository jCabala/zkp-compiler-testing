...
type smtlib2_lia struct {
	...
	FVar_scr1_x3 frontend.Variable
	FVar_scr1_x4 frontend.Variable
	FVar_scr1_x5 frontend.Variable
	FVar_scr2_x1 frontend.Variable
	FVar_scr2_x2 frontend.Variable
	FVar_scr2_x3 frontend.Variable
	FVar_scr1_x2_scr2_x2_fused frontend.Variable `gnark:",public"`
	FVar_scr1_x3_scr2_x1_fused frontend.Variable `gnark:",public"`
	FVar_scr1_x1_scr2_x3_fused frontend.Variable `gnark:",public"`
}
...
func (circuit *smtlib2_lia) Define(api frontend.API) error {
	...
	CircuitVarIn(circuit.FVar_scr1_x3)
	Label(circuit.FVar_scr1_x3, "scr1_x3")
	CircuitVarIn(circuit.FVar_scr1_x4)
	Label(circuit.FVar_scr1_x4, "scr1_x4")
	CircuitVarIn(circuit.FVar_scr1_x5)
	Label(circuit.FVar_scr1_x5, "scr1_x5")
	...
	CircuitVarIn(circuit.FVar_scr2_x3)
	Label(circuit.FVar_scr2_x3, "scr2_x3")
	CircuitVarOut(circuit.FVar_scr1_x2_scr2_x2_fused)
	Label(circuit.FVar_scr1_x2_scr2_x2_fused, "scr1_x2_scr2_x2_fused")
	CircuitVarOut(circuit.FVar_scr1_x3_scr2_x1_fused)
	Label(circuit.FVar_scr1_x3_scr2_x1_fused, "scr1_x3_scr2_x1_fused")
	CircuitVarOut(circuit.FVar_scr1_x1_scr2_x3_fused)
	Label(circuit.FVar_scr1_x1_scr2_x3_fused, "scr1_x1_scr2_x3_fused")
	api.AssertIsBoolean(circuit.FVar_scr1_x1)
	api.AssertIsBoolean(circuit.FVar_scr1_x2)
	api.AssertIsBoolean(circuit.FVar_scr1_x3)
	api.AssertIsBoolean(circuit.FVar_scr1_x4)
	api.AssertIsBoolean(circuit.FVar_scr1_x5)
	api.AssertIsBoolean(circuit.FVar_scr2_x1)
	api.AssertIsBoolean(circuit.FVar_scr2_x2)
	api.AssertIsBoolean(circuit.FVar_scr2_x3)
	api.AssertIsBoolean(circuit.FVar_scr1_x2_scr2_x2_fused)
	api.AssertIsBoolean(circuit.FVar_scr1_x3_scr2_x1_fused)
	api.AssertIsBoolean(circuit.FVar_scr1_x1_scr2_x3_fused)
	api.AssertIsEqual(api.And(api.And(api.And(api.And(api.And(api.And(api.And(api.And(api.IsZero(api.Cmp(circuit.FVar_scr1_x1_scr2_x3_fused, circuit.FVar_scr2_x3)), api.IsZero(api.IsZero(api.Cmp(circuit.FVar_scr1_x3_scr2_x1_fused, circuit.FVar_scr2_x1)))), api.IsZero(circuit.FVar_scr1_x5)), circuit.FVar_scr1_x2_scr2_x2_fused), circuit.FVar_scr1_x4), api.Or(circuit.FVar_scr2_x1, api.IsZero(circuit.FVar_scr2_x3))), circuit.FVar_scr2_x2), api.Or(circuit.FVar_scr2_x3, api.IsZero(circuit.FVar_scr2_x1))), api.Or(circuit.FVar_scr2_x1, circuit.FVar_scr2_x3)), 1)
	api.Println("scr1_x2_scr2_x2_fused:", circuit.FVar_scr1_x2_scr2_x2_fused)
	api.Println("scr1_x3_scr2_x1_fused:", circuit.FVar_scr1_x3_scr2_x1_fused)
	api.Println("scr1_x1_scr2_x3_fused:", circuit.FVar_scr1_x1_scr2_x3_fused)
	return nil // no error
}
