...
func (circuit *smtlib2_lia) Define(api frontend.API) error {
	...
	api.AssertIsEqual(api.And(api.And(api.And(api.IsZero(circuit.FVar_scr1_x1), circuit.FVar_scr1_x2), circuit.FVar_scr1_x2_scr2_x2_fused), circuit.FVar_scr2_x1), 1)
