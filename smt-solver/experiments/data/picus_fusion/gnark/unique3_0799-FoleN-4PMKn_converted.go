...
type smtlib2_lia struct {
	...
	FVar_scr1_x5_scr2_x2_fused frontend.Variable `gnark:",public"`
...
func (circuit *smtlib2_lia) Define(api frontend.API) error {
	...
	CircuitVarOut(circuit.FVar_scr1_x5_scr2_x2_fused)
	Label(circuit.FVar_scr1_x5_scr2_x2_fused, "scr1_x5_scr2_x2_fused")
	...
	api.AssertIsBoolean(circuit.FVar_scr1_x5_scr2_x2_fused)
	api.AssertIsBoolean(circuit.FVar_scr1_x2_scr2_x3_fused)
	api.AssertIsEqual(api.And(api.And(api.And(api.And(api.And(api.And(api.And(api.And(api.IsZero(api.Cmp(circuit.FVar_scr1_x1_scr2_x1_fused, circuit.FVar_scr2_x1)), circuit.FVar_scr1_x3), circuit.FVar_scr1_x5_scr2_x2_fused), api.IsZero(api.Cmp(circuit.FVar_scr1_x2_scr2_x3_fused, circuit.FVar_scr2_x3))), circuit.FVar_scr1_x4), api.Or(circuit.FVar_scr2_x1, api.IsZero(circuit.FVar_scr2_x3))), circuit.FVar_scr2_x2), api.Or(circuit.FVar_scr2_x3, api.IsZero(circuit.FVar_scr2_x1))), api.Or(circuit.FVar_scr2_x1, circuit.FVar_scr2_x3)), 1)
	api.Println("scr1_x1_scr2_x1_fused:", circuit.FVar_scr1_x1_scr2_x1_fused)
	api.Println("scr1_x5_scr2_x2_fused:", circuit.FVar_scr1_x5_scr2_x2_fused)
