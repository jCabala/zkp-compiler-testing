...
func (circuit *smtlib2_lia) Define(api frontend.API) error {
	...
	api.AssertIsEqual(api.And(api.And(api.And(api.And(api.And(api.And(api.And(api.And(api.IsZero(circuit.FVar_scr1_x1), api.IsZero(api.IsZero(api.Cmp(circuit.FVar_scr1_x3_scr2_x1_fused, circuit.FVar_scr2_x1)))), api.IsZero(api.Cmp(circuit.FVar_scr1_x2_scr2_x3_fused, circuit.FVar_scr2_x3))), circuit.FVar_scr1_x4), api.IsZero(circuit.FVar_scr1_x5)), api.Or(circuit.FVar_scr2_x1, api.IsZero(circuit.FVar_scr2_x3))), circuit.FVar_scr2_x2), api.Or(circuit.FVar_scr2_x3, api.IsZero(circuit.FVar_scr2_x1))), api.Or(circuit.FVar_scr2_x1, circuit.FVar_scr2_x3)), 1)
