...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0734--prune3--seed50.smt2
; backend=circom
...
(assert (= (ff.mul v2 v1) (ff.add v1 v2 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v150))))
...
(assert (= (ff.mul v202 v2) (ff.add v2 v202 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v230))))
(assert (= (ff.mul v230 v261) (as ff1 F)))
(assert (= (ff.mul v1 v2) (ff.add v1 v2 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v287))))
...
(assert (= (ff.mul v3 (ff.add (as ff1 F) (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v2))) (ff.add (as ff1 F) (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v2) v3 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v539))))
(assert (= (ff.mul v539 v552) (as ff1 F)))
(assert (= (ff.mul v287 v573) (as ff1 F)))
