...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0847--prune3--seed48.smt2
; backend=circom
...
(assert (= (ff.mul v44 v2) (ff.add v2 v44 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v47))))
...
(assert (= (ff.mul v1249 v1259) (as ff1 F)))
