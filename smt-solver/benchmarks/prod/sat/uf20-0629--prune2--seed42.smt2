...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0629--prune2--seed42.smt2
; backend=circom
...
(assert (= (ff.mul v1 v279) (as ff1 F)))
...
(assert (= (ff.mul v1172 v1180) (as ff1 F)))
