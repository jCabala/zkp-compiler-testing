...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0647--prune3--seed45.smt2
; backend=circom
...
(assert (= (ff.mul v46 v3) (ff.add v3 v46 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v49))))
