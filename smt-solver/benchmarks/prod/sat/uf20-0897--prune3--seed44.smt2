...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0897--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v117 v122) (as ff1 F)))
(assert (= (ff.mul v3 v168) (as ff1 F)))
(assert (= (ff.mul v1 v490) (as ff1 F)))
(assert (= (ff.mul v1 v619) (as ff1 F)))
(assert (= (ff.mul v1 v768) (as ff1 F)))
(assert (= (ff.mul (ff.add (as ff1 F) (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v2)) v884) (as ff1 F)))
