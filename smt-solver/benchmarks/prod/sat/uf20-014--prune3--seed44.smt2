...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-014--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v480 v493) (as ff1 F)))
...
(assert (= (ff.mul v784 v796) (as ff1 F)))
