...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0429--prune3--seed45.smt2
; backend=circom
...
(assert (= (ff.mul v453 v458) (as ff1 F)))
...
(assert (= (ff.mul v972 v985) (as ff1 F)))
