...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0939--prune3--seed50.smt2
; backend=circom
...
(assert (= (ff.mul v701 (ff.add (as ff1 F) (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v1))) (ff.add (as ff1 F) (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v1) v701 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v706))))
(assert (= (ff.mul v706 v711) (as ff1 F)))
...
(assert (= (ff.mul v3 v1225) (as ff1 F)))
