...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0690--prune3--seed50.smt2
; backend=circom
...
(assert (= (ff.mul v747 v752) (as ff1 F)))
...
(assert (= (ff.mul v856 v864) (as ff1 F)))
