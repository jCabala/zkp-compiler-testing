...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0106--prune3--seed45.smt2
; backend=circom
...
(assert (= (ff.mul v147 v2) (ff.add v2 v147 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v175))))
(assert (= (ff.mul v175 v205) (as ff1 F)))
