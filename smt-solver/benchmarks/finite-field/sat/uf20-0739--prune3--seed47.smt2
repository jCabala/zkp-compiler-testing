...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0739--prune3--seed47.smt2
; backend=circom
...
(assert (= (ff.mul v528 v1) (ff.add v1 v528 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v531))))
...
(assert (= (ff.mul v1070 v1075) (as ff1 F)))
