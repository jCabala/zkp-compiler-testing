...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0702--prune3--seed48.smt2
; backend=circom
...
(assert (= (ff.mul v1 v523) (as ff1 F)))
...
(assert (= (ff.mul v1 v683) (as ff1 F)))
(assert (= (ff.mul v3 v699) (as ff1 F)))
