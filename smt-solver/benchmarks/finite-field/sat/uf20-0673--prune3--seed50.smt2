...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0673--prune3--seed50.smt2
; backend=circom
...
(assert (= (ff.mul v424 v455) (as ff1 F)))
(assert (= (ff.mul v3 v664) (as ff1 F)))
(assert (= (ff.mul v3 v890) (as ff1 F)))
