...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0552--prune3--seed47.smt2
; backend=circom
...
(assert (= (ff.mul v963 v968) (as ff1 F)))
(assert (= (ff.mul v3 v1090) (as ff1 F)))
