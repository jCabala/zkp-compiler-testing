...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0328--prune3--seed45.smt2
; backend=circom
...
(assert (= (ff.mul v402 v407) (as ff1 F)))
...
(assert (= (ff.mul v3 v711) (as ff1 F)))
(assert (= (ff.mul v3 v782) (as ff1 F)))
