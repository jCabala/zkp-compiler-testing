...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0903--prune3--seed47.smt2
; backend=circom
...
(assert (= (ff.mul v1036 v1046) (as ff1 F)))
(assert (= (ff.mul v3 v1115) (as ff1 F)))
