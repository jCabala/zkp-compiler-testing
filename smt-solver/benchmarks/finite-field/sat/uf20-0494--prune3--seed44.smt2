...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0494--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v91 v99) (as ff1 F)))
...
(assert (= (ff.mul v1190 v1201) (as ff1 F)))
