...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0531--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v3 v1) (ff.add v1 v3 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v329))))
(assert (= (ff.mul v329 v337) (as ff1 F)))
(assert (= (ff.mul v3 v456) (as ff1 F)))
(assert (= (ff.mul v1 v2) (ff.add v1 v2 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v569))))
...
(assert (= (ff.mul v955 v963) (as ff1 F)))
...
(assert (= (ff.mul v1111 v1129) (as ff1 F)))
