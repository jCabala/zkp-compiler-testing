...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0701--prune2--seed51.smt2
; backend=circom
...
(assert (= (ff.mul v207 v212) (as ff1 F)))
...
(assert (= (ff.mul v1 v915) (as ff1 F)))
