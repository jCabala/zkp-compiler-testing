...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0967--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v730 v740) (as ff1 F)))
(assert (= (ff.mul v2 v789) (as ff1 F)))
(assert (= (ff.mul v3 v815) (as ff1 F)))
(assert (= (ff.mul v3 v828) (as ff1 F)))
(assert (= (ff.mul v3 v2) (ff.add v2 v3 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v967))))
(assert (= (ff.mul v967 v972) (as ff1 F)))
