...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0315--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v828 v835) (as ff1 F)))
(assert (= (ff.mul v3 v1060) (as ff1 F)))
(assert (= (ff.mul v3 v1238) (as ff1 F)))
