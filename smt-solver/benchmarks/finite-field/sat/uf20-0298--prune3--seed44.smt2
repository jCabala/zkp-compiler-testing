...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0298--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v3 v1045) (as ff1 F)))
...
(assert (= (ff.mul v1198 v1206) (as ff1 F)))
