...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0509--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v102 v107) (as ff1 F)))
...
(assert (= (ff.mul v1 v499) (as ff1 F)))
...
(assert (= (ff.mul v736 v767) (as ff1 F)))
