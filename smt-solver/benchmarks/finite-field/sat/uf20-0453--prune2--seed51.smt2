...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0453--prune2--seed51.smt2
; backend=circom
...
(assert (= (ff.mul v474 v484) (as ff1 F)))
...
(assert (= (ff.mul v1074 v1087) (as ff1 F)))
