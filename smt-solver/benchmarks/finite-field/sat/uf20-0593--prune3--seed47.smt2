...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0593--prune3--seed47.smt2
; backend=circom
...
(assert (= (ff.mul v317 v328) (as ff1 F)))
(assert (= (ff.mul v3 v372) (as ff1 F)))
(assert (= (ff.mul v3 v638) (as ff1 F)))
(assert (= (ff.mul v3 v649) (as ff1 F)))
(assert (= (ff.mul v2 v786) (as ff1 F)))
(assert (= (ff.mul v2 v1) (ff.add v1 v2 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v808))))
