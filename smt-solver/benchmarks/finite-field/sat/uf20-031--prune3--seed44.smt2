...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-031--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v2 v552) (as ff1 F)))
...
(assert (= (ff.mul v2 v883) (as ff1 F)))
