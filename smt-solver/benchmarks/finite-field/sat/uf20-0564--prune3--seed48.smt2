...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0564--prune3--seed48.smt2
; backend=circom
...
(assert (= (ff.mul v188 (ff.add (as ff1 F) (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v2))) (ff.add (as ff1 F) (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v2) v188 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v193))))
(assert (= (ff.mul v193 v198) (as ff1 F)))
(assert (= (ff.mul (ff.add (as ff1 F) (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v1)) v443) (as ff1 F)))
