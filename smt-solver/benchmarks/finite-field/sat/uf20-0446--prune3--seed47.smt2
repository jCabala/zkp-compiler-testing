...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0446--prune3--seed47.smt2
; backend=circom
...
(assert (= (ff.mul v3 v457) (as ff1 F)))
(assert (= (ff.mul v1 v675) (as ff1 F)))
(assert (= (ff.mul v3 v780) (as ff1 F)))
(assert (= (ff.mul v3 v887) (as ff1 F)))
