...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0515--prune3--seed45.smt2
; backend=circom
...
(assert (= (ff.mul v137 v150) (as ff1 F)))
(assert (= (ff.mul v2 v240) (as ff1 F)))
(assert (= (ff.mul v2 v297) (as ff1 F)))
(assert (= (ff.mul v3 v405) (as ff1 F)))
(assert (= (ff.mul v2 v497) (as ff1 F)))
(assert (= (ff.mul v2 v3) (ff.add v2 v3 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v590))))
(assert (= (ff.mul v590 v595) (as ff1 F)))
