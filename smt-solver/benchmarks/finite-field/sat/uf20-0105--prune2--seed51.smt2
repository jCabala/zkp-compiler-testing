...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0105--prune2--seed51.smt2
; backend=circom
...
(assert (= (ff.mul v800 v812) (as ff1 F)))
...
(assert (= (ff.mul v1057 v1086) (as ff1 F)))
