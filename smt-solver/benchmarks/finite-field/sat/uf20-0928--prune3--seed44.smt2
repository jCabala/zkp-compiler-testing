...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0928--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v3 v223) (as ff1 F)))
...
(assert (= (ff.mul v549 v559) (as ff1 F)))
