...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0943--prune3--seed45.smt2
; backend=circom
...
(assert (= (ff.mul v3 v1) (ff.add v1 v3 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v231))))
(assert (= (ff.mul v231 v291) (as ff1 F)))
...
(assert (= (ff.mul v614 v624) (as ff1 F)))
...
(assert (= (ff.mul v3 v753) (as ff1 F)))
(assert (= (ff.mul v3 v797) (as ff1 F)))
(assert (= (ff.mul v2 v1) (ff.add v1 v2 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v959))))
(assert (= (ff.mul v959 v964) (as ff1 F)))
(assert (= (ff.mul v2 v1141) (as ff1 F)))
(assert (= (ff.mul v1 v3) (ff.add v1 v3 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v1179))))
(assert (= (ff.mul v1179 v1184) (as ff1 F)))
