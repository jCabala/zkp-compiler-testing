...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0963--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v3 v707) (as ff1 F)))
...
(assert (= (ff.mul v1263 v1268) (as ff1 F)))
