...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0772--prune2--seed43.smt2
; backend=circom
...
(assert (= (ff.mul v94 v102) (as ff1 F)))
(assert (= (ff.mul v2 v115) (as ff1 F)))
(assert (= (ff.mul v1 v222) (as ff1 F)))
