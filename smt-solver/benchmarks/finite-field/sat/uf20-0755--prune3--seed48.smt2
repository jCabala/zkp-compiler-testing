...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0755--prune3--seed48.smt2
; backend=circom
...
(assert (= (ff.mul v1 v858) (as ff1 F)))
(assert (= (ff.mul v851 v861) (as ff1 F)))
