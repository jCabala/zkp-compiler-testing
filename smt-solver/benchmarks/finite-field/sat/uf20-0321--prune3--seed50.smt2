...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0321--prune3--seed50.smt2
; backend=circom
...
(assert (= (ff.mul v338 v348) (as ff1 F)))
...
(assert (= (ff.mul v384 v392) (as ff1 F)))
