...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0857--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v3 v316) (as ff1 F)))
...
(assert (= (ff.mul v844 v852) (as ff1 F)))
