...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0933--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v90 v100) (as ff1 F)))
...
(assert (= (ff.mul v434 v439) (as ff1 F)))
