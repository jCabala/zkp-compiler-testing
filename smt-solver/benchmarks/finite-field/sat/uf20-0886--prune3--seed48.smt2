...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0886--prune3--seed48.smt2
; backend=circom
...
(assert (= (ff.mul v102 v3) (ff.add v3 v102 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v105))))
...
(assert (= (ff.mul v1023 v1031) (as ff1 F)))
