...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0533--prune3--seed48.smt2
; backend=circom
...
(assert (= (ff.mul v3 v430) (as ff1 F)))
...
(assert (= (ff.mul v1086 v1131) (as ff1 F)))
