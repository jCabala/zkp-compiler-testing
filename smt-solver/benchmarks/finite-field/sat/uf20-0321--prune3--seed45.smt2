...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0321--prune3--seed45.smt2
; backend=circom
...
(assert (= (ff.mul v58 v66) (as ff1 F)))
...
(assert (= (ff.mul v860 v890) (as ff1 F)))
