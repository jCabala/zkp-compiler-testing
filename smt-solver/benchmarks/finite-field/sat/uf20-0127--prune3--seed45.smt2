...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0127--prune3--seed45.smt2
; backend=circom
...
(assert (= (ff.mul v3 v614) (as ff1 F)))
...
(assert (= (ff.mul v802 v891) (as ff1 F)))
(assert (= (ff.mul v3 v962) (as ff1 F)))
(assert (= (ff.mul v3 v1211) (as ff1 F)))
