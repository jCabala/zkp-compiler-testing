...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0295--prune3--seed47.smt2
; backend=circom
...
(assert (= (ff.mul v960 v965) (as ff1 F)))
...
(assert (= (ff.mul v1168 v1181) (as ff1 F)))
