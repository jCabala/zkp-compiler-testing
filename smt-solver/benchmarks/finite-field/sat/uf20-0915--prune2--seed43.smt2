...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0915--prune2--seed43.smt2
; backend=circom
...
(assert (= (ff.mul v739 v744) (as ff1 F)))
(assert (= (ff.mul v1 v808) (as ff1 F)))
(assert (= (ff.mul v2 v820) (as ff1 F)))
