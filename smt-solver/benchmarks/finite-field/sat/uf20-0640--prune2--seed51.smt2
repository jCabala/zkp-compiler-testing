...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0640--prune2--seed51.smt2
; backend=circom
...
(assert (= (ff.mul v36 v97) (as ff1 F)))
(assert (= (ff.mul v1 v268) (as ff1 F)))
(assert (= (ff.mul v1 v638) (as ff1 F)))
(assert (= (ff.mul v1 v986) (as ff1 F)))
