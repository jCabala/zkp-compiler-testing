...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0583--prune3--seed48.smt2
; backend=circom
...
(assert (= (ff.mul v3 v427) (as ff1 F)))
...
(assert (= (ff.mul v1154 v1185) (as ff1 F)))
