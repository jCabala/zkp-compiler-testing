...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0323--prune3--seed47.smt2
; backend=circom
...
(assert (= (ff.mul v308 v321) (as ff1 F)))
...
(assert (= (ff.mul v804 v814) (as ff1 F)))
