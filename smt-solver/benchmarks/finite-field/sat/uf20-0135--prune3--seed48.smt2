...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0135--prune3--seed48.smt2
; backend=circom
...
(assert (= (ff.mul v3 v469) (as ff1 F)))
...
(assert (= (ff.mul v476 v484) (as ff1 F)))
