...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0619--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v32 v1) (ff.add v1 v32 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v35))))
(assert (= (ff.mul v2 v40) (as ff1 F)))
(assert (= (ff.mul v35 v43) (as ff1 F)))
...
(assert (= (ff.mul v1 v728) (as ff1 F)))
(assert (= (ff.mul v2 v1042) (as ff1 F)))
(assert (= (ff.mul v2 v1232) (as ff1 F)))
