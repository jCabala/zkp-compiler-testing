...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-053--prune3--seed45.smt2
; backend=circom
...
(assert (= (ff.mul v3 v343) (as ff1 F)))
...
(assert (= (ff.mul v3 v825) (as ff1 F)))
