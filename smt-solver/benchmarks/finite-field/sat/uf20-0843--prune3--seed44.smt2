...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0843--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v938 v943) (as ff1 F)))
...
(assert (= (ff.mul v2 v1281) (as ff1 F)))
