...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0704--prune3--seed47.smt2
; backend=circom
...
(assert (= (ff.mul v65 v70) (as ff1 F)))
...
(assert (= (ff.mul v2 v739) (as ff1 F)))
