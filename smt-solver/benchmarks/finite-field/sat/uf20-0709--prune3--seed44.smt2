...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0709--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v33 v41) (as ff1 F)))
(assert (= (ff.mul v3 v54) (as ff1 F)))
