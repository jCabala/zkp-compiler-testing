...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0709--prune2--seed46.smt2
; backend=circom
...
(assert (= (ff.mul v416 v421) (as ff1 F)))
...
(assert (= (ff.mul v1120 v1130) (as ff1 F)))
