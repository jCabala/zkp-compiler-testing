...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0598--prune3--seed45.smt2
; backend=circom
...
(assert (= (ff.mul v874 v879) (as ff1 F)))
...
(assert (= (ff.mul v1066 v1076) (as ff1 F)))
