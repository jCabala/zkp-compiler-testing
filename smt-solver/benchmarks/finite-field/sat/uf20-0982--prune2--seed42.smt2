...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0982--prune2--seed42.smt2
; backend=circom
...
(assert (= (ff.mul v641 v651) (as ff1 F)))
(assert (= (ff.mul v1 v788) (as ff1 F)))
(assert (= (ff.mul v2 v872) (as ff1 F)))
(assert (= (ff.mul v2 v1062) (as ff1 F)))
