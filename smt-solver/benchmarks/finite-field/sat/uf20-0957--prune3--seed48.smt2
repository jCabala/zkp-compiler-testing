...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0957--prune3--seed48.smt2
; backend=circom
...
(assert (= (ff.mul v68 v73) (as ff1 F)))
...
(assert (= (ff.mul v828 v838) (as ff1 F)))
