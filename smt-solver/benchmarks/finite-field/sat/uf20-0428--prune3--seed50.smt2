...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0428--prune3--seed50.smt2
; backend=circom
...
(assert (= (ff.mul v50 v58) (as ff1 F)))
...
(assert (= (ff.mul (ff.add (as ff1 F) (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v2)) v541) (as ff1 F)))
...
(assert (= (ff.mul v2 v3) (ff.add v2 v3 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v1261))))
(assert (= (ff.mul v1261 v1266) (as ff1 F)))
