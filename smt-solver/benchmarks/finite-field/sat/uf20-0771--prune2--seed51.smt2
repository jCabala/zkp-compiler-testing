...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0771--prune2--seed51.smt2
; backend=circom
...
(assert (= (ff.mul v36 v41) (as ff1 F)))
...
(assert (= (ff.mul v521 v531) (as ff1 F)))
