...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-024--prune3--seed50.smt2
; backend=circom
...
(assert (= (ff.mul v3 v653) (as ff1 F)))
...
(assert (= (ff.mul v705 v710) (as ff1 F)))
(assert (= (ff.mul v1 v996) (as ff1 F)))
(assert (= (ff.mul (ff.add (as ff1 F) (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v2)) v1128) (as ff1 F)))
