...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0314--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v1 v597) (as ff1 F)))
(assert (= (ff.mul v1 v3) (ff.add v1 v3 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v966))))
(assert (= (ff.mul v966 v971) (as ff1 F)))
...
(assert (= (ff.mul v1096 v1101) (as ff1 F)))
