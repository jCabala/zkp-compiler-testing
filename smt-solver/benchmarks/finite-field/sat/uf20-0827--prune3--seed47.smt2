...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0827--prune3--seed47.smt2
; backend=circom
...
(assert (= (ff.mul v147 v176) (as ff1 F)))
...
(assert (= (ff.mul v3 v570) (as ff1 F)))
