...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0512--prune3--seed50.smt2
; backend=circom
...
(assert (= (ff.mul v344 v352) (as ff1 F)))
...
(assert (= (ff.mul v1076 v1084) (as ff1 F)))
