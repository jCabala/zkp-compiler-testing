...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0881--prune2--seed46.smt2
; backend=circom
...
(assert (= (ff.mul v92 v97) (as ff1 F)))
...
(assert (= (ff.mul v929 v934) (as ff1 F)))
