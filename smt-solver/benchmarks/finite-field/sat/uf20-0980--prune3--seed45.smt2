...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0980--prune3--seed45.smt2
; backend=circom
...
(assert (= (ff.mul v1 v2) (ff.add v1 v2 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v295))))
(assert (= (ff.mul v295 v300) (as ff1 F)))
...
(assert (= (ff.mul v452 v459) (as ff1 F)))
(assert (= (ff.mul v3 (ff.add (as ff1 F) (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v2))) (ff.add (as ff1 F) (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v2) v3 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v517))))
(assert (= (ff.mul v517 v525) (as ff1 F)))
...
(assert (= (ff.mul v1043 v1054) (as ff1 F)))
(assert (= (ff.mul v3 v1179) (as ff1 F)))
