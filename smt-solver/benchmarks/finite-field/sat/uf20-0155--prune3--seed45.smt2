...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0155--prune3--seed45.smt2
; backend=circom
...
(assert (= (ff.mul v962 v967) (as ff1 F)))
(assert (= (ff.mul v1 v1073) (as ff1 F)))
(assert (= (ff.mul v1 v1105) (as ff1 F)))
(assert (= (ff.mul v3 v1157) (as ff1 F)))
