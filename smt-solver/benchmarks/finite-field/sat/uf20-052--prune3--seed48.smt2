...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-052--prune3--seed48.smt2
; backend=circom
...
(assert (= (ff.mul v1 v128) (as ff1 F)))
...
(assert (= (ff.mul v493 v503) (as ff1 F)))
