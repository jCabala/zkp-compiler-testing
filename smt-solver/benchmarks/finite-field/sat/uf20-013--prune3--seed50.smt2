...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-013--prune3--seed50.smt2
; backend=circom
...
(assert (= (ff.mul v235 v266) (as ff1 F)))
...
(assert (= (ff.mul v3 v1112) (as ff1 F)))
