...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0600--prune3--seed50.smt2
; backend=circom
...
(assert (= (ff.mul v1 v873) (as ff1 F)))
...
(assert (= (ff.mul v924 v932) (as ff1 F)))
(assert (= (ff.mul v3 v2) (ff.add v2 v3 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v941))))
...
(assert (= (ff.mul v995 v1000) (as ff1 F)))
