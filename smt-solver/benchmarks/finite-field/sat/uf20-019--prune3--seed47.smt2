...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-019--prune3--seed47.smt2
; backend=circom
...
(assert (= (ff.mul v3 v501) (as ff1 F)))
...
(assert (= (ff.mul v1 v1112) (as ff1 F)))
