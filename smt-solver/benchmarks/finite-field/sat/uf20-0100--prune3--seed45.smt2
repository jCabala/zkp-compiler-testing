...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0100--prune3--seed45.smt2
; backend=circom
...
(assert (= (ff.mul v107 v115) (as ff1 F)))
(assert (= (ff.mul v1 v196) (as ff1 F)))
(assert (= (ff.mul v2 v295) (as ff1 F)))
(assert (= (ff.mul v3 v361) (as ff1 F)))
