...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0324--prune2--seed43.smt2
; backend=circom
...
(assert (= (ff.mul v469 v477) (as ff1 F)))
...
(assert (= (ff.mul v961 v966) (as ff1 F)))
