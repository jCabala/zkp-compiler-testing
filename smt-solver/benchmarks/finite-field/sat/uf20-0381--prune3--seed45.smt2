...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0381--prune3--seed45.smt2
; backend=circom
...
(assert (= (ff.mul v352 v412) (as ff1 F)))
(assert (= (ff.mul v3 v433) (as ff1 F)))
(assert (= (ff.mul v3 v553) (as ff1 F)))
