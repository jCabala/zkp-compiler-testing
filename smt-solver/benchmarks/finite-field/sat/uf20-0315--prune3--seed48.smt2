...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0315--prune3--seed48.smt2
; backend=circom
...
(assert (= (ff.mul v116 v126) (as ff1 F)))
...
(assert (= (ff.mul v284 v297) (as ff1 F)))
