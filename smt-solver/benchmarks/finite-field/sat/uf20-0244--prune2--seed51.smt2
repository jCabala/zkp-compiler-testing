...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0244--prune2--seed51.smt2
; backend=circom
...
(assert (= (ff.mul v1 v359) (as ff1 F)))
...
(assert (= (ff.mul v823 v828) (as ff1 F)))
