...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0555--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v68 v76) (as ff1 F)))
(assert (= (ff.mul v3 v624) (as ff1 F)))
(assert (= (ff.mul v3 v863) (as ff1 F)))
