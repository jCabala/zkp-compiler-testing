...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0628--prune2--seed46.smt2
; backend=circom
...
(assert (= (ff.mul v2 v831) (as ff1 F)))
...
(assert (= (ff.mul v1146 v1156) (as ff1 F)))
