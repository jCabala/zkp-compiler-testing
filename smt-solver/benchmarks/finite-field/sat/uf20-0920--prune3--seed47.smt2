...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0920--prune3--seed47.smt2
; backend=circom
...
(assert (= (ff.mul v9 v1) (ff.add v1 v9 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v38))))
(assert (= (ff.mul v1 v66) (as ff1 F)))
(assert (= (ff.mul v38 v69) (as ff1 F)))
...
(assert (= (ff.mul v686 v699) (as ff1 F)))
