...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0940--prune3--seed47.smt2
; backend=circom
...
(assert (= (ff.mul v94 v99) (as ff1 F)))
(assert (= (ff.mul v2 v156) (as ff1 F)))
(assert (= (ff.mul v1 v198) (as ff1 F)))
(assert (= (ff.mul v1 v563) (as ff1 F)))
(assert (= (ff.mul v1 v755) (as ff1 F)))
(assert (= (ff.mul v1 v2) (ff.add v1 v2 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v852))))
...
(assert (= (ff.mul v2 v1) (ff.add v1 v2 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v1044))))
(assert (= (ff.mul v1044 v1054) (as ff1 F)))
