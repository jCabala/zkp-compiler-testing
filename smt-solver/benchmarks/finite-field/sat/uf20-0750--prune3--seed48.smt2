...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0750--prune3--seed48.smt2
; backend=circom
...
(assert (= (ff.mul v1106 v3) (ff.add v3 v1106 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v1111))))
(assert (= (ff.mul v1111 v1116) (as ff1 F)))
