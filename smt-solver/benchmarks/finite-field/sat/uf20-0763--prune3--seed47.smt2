...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0763--prune3--seed47.smt2
; backend=circom
...
(assert (= (ff.mul v3 v270) (as ff1 F)))
(assert (= (ff.mul v3 v302) (as ff1 F)))
(assert (= (ff.mul v3 v413) (as ff1 F)))
(assert (= (ff.mul v3 v426) (as ff1 F)))
...
(assert (= (ff.mul v489 v499) (as ff1 F)))
(assert (= (ff.mul (ff.add (as ff1 F) (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v2)) v664) (as ff1 F)))
