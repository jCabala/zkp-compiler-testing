...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0183--prune3--seed50.smt2
; backend=circom
...
(assert (= (ff.mul v3 v341) (as ff1 F)))
...
(assert (= (ff.mul v544 v549) (as ff1 F)))
