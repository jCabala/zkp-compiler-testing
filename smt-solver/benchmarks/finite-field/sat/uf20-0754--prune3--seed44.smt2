...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0754--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v707 v715) (as ff1 F)))
...
(assert (= (ff.mul v769 v781) (as ff1 F)))
...
(assert (= (ff.mul v1024 v1053) (as ff1 F)))
