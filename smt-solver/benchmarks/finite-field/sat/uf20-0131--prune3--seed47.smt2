...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0131--prune3--seed47.smt2
; backend=circom
...
(assert (= (ff.mul v81 v91) (as ff1 F)))
(assert (= (ff.mul v3 v333) (as ff1 F)))
(assert (= (ff.mul v2 v422) (as ff1 F)))
(assert (= (ff.mul v3 v495) (as ff1 F)))
(assert (= (ff.mul v2 v1) (ff.add v1 v2 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v869))))
(assert (= (ff.mul v869 v874) (as ff1 F)))
