...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0159--prune3--seed48.smt2
; backend=circom
...
(assert (= (ff.mul v540 v575) (as ff1 F)))
...
(assert (= (ff.mul v826 v916) (as ff1 F)))
