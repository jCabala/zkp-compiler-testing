...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-063--prune3--seed45.smt2
; backend=circom
...
(assert (= (ff.mul v254 v265) (as ff1 F)))
...
(assert (= (ff.mul v3 v978) (as ff1 F)))
