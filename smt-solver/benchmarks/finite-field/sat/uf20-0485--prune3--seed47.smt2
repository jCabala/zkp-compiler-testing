...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0485--prune3--seed47.smt2
; backend=circom
...
(assert (= (ff.mul v3 v168) (as ff1 F)))
(assert (= (ff.mul v1 v455) (as ff1 F)))
(assert (= (ff.mul v1 v515) (as ff1 F)))
(assert (= (ff.mul v3 v561) (as ff1 F)))
