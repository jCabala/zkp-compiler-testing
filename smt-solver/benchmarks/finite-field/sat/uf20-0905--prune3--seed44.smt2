...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0905--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v94 v104) (as ff1 F)))
...
(assert (= (ff.mul v3 v874) (as ff1 F)))
