...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0154--prune3--seed48.smt2
; backend=circom
...
(assert (= (ff.mul v1 v195) (as ff1 F)))
...
(assert (= (ff.mul v3 v407) (as ff1 F)))
