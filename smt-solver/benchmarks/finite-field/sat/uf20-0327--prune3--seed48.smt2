...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0327--prune3--seed48.smt2
; backend=circom
...
(assert (= (ff.mul v3 v377) (as ff1 F)))
(assert (= (ff.mul v3 v508) (as ff1 F)))
(assert (= (ff.mul v2 v767) (as ff1 F)))
(assert (= (ff.mul v2 v898) (as ff1 F)))
(assert (= (ff.mul v3 v1) (ff.add v1 v3 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v967))))
(assert (= (ff.mul v967 v977) (as ff1 F)))
