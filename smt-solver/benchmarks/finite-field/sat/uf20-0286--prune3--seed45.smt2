...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0286--prune3--seed45.smt2
; backend=circom
...
(assert (= (ff.mul v3 v217) (as ff1 F)))
...
(assert (= (ff.mul v455 v460) (as ff1 F)))
(assert (= (ff.mul v3 v581) (as ff1 F)))
(assert (= (ff.mul v3 v747) (as ff1 F)))
(assert (= (ff.mul v3 v833) (as ff1 F)))
