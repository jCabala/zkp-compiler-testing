...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0872--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v505 v510) (as ff1 F)))
...
(assert (= (ff.mul v576 v586) (as ff1 F)))
