...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0804--prune2--seed46.smt2
; backend=circom
...
(assert (= (ff.mul v23 v33) (as ff1 F)))
(assert (= (ff.mul v1 v127) (as ff1 F)))
(assert (= (ff.mul v1 v767) (as ff1 F)))
