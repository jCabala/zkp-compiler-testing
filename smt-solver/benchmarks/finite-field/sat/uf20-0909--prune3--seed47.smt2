...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0909--prune3--seed47.smt2
; backend=circom
...
(assert (= (ff.mul v631 v636) (as ff1 F)))
...
(assert (= (ff.mul v792 v802) (as ff1 F)))
