...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0668--prune3--seed47.smt2
; backend=circom
...
(assert (= (ff.mul v882 v913) (as ff1 F)))
...
(assert (= (ff.mul v991 v1004) (as ff1 F)))
