...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0789--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v3 v785) (as ff1 F)))
...
(assert (= (ff.mul v1079 v1087) (as ff1 F)))
