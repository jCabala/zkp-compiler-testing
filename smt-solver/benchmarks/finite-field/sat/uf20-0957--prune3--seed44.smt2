...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0957--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v2 v502) (as ff1 F)))
...
(assert (= (ff.mul v988 v998) (as ff1 F)))
(assert (= (ff.mul v3 v1077) (as ff1 F)))
