...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-071--prune3--seed48.smt2
; backend=circom
...
(assert (= (ff.mul v1229 v1241) (as ff1 F)))
(assert (= (ff.mul v1 v1265) (as ff1 F)))
