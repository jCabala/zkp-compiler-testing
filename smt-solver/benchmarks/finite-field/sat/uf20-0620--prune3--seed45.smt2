...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0620--prune3--seed45.smt2
; backend=circom
...
(assert (= (ff.mul v286 v296) (as ff1 F)))
...
(assert (= (ff.mul v1244 v1257) (as ff1 F)))
(assert (= (ff.mul v1221 v1279) (as ff1 F)))
