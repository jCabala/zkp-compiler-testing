...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0854--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v729 v740) (as ff1 F)))
...
(assert (= (ff.mul v894 v904) (as ff1 F)))
