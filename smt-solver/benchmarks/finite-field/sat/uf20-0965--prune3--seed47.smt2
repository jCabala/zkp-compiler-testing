...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0965--prune3--seed47.smt2
; backend=circom
...
(assert (= (ff.mul v260 v267) (as ff1 F)))
(assert (= (ff.mul v3 v333) (as ff1 F)))
(assert (= (ff.mul v3 v425) (as ff1 F)))
(assert (= (ff.mul v3 v557) (as ff1 F)))
...
(assert (= (ff.mul v940 v953) (as ff1 F)))
