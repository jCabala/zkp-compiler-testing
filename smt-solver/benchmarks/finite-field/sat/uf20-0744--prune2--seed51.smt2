...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0744--prune2--seed51.smt2
; backend=circom
...
(assert (= (ff.mul v485 v493) (as ff1 F)))
...
(assert (= (ff.mul v1032 v1063) (as ff1 F)))
