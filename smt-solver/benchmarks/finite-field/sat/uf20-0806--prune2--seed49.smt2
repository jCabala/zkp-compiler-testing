...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0806--prune2--seed49.smt2
; backend=circom
...
(assert (= (ff.mul v2 v1096) (as ff1 F)))
...
(assert (= (ff.mul v1262 v1267) (as ff1 F)))
