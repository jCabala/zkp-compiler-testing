...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0399--prune3--seed50.smt2
; backend=circom
...
(assert (= (ff.mul v1 v437) (as ff1 F)))
(assert (= (ff.mul v3 v481) (as ff1 F)))
(assert (= (ff.mul v2 v575) (as ff1 F)))
...
(assert (= (ff.mul v2 v1) (ff.add v1 v2 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v924))))
(assert (= (ff.mul v924 v929) (as ff1 F)))
