...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-049--prune2--seed43.smt2
; backend=circom
...
(assert (= (ff.mul v968 v973) (as ff1 F)))
(assert (= (ff.mul v2 v986) (as ff1 F)))
...
(assert (= (ff.mul v1021 v1081) (as ff1 F)))
