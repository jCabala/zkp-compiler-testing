...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0875--prune3--seed47.smt2
; backend=circom
...
(assert (= (ff.mul v399 v407) (as ff1 F)))
...
(assert (= (ff.mul v1237 v1242) (as ff1 F)))
