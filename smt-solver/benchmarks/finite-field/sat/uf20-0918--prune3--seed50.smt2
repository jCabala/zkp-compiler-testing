...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0918--prune3--seed50.smt2
; backend=circom
...
(assert (= (ff.mul v774 v865) (as ff1 F)))
...
(assert (= (ff.mul v1153 v1158) (as ff1 F)))
