...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-08--prune2--seed42.smt2
; backend=circom
...
(assert (= (ff.mul v2 v218) (as ff1 F)))
...
(assert (= (ff.mul v417 v422) (as ff1 F)))
...
(assert (= (ff.mul v967 v998) (as ff1 F)))
