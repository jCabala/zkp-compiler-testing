...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0742--prune3--seed50.smt2
; backend=circom
...
(assert (= (ff.mul v3 v277) (as ff1 F)))
...
(assert (= (ff.mul v3 v995) (as ff1 F)))
