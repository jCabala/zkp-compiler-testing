...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0702--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v491 v580) (as ff1 F)))
(assert (= (ff.mul v3 v699) (as ff1 F)))
(assert (= (ff.mul v1 v714) (as ff1 F)))
