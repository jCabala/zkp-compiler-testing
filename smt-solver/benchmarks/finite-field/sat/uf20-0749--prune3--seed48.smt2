...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0749--prune3--seed48.smt2
; backend=circom
...
(assert (= (ff.mul v3 v345) (as ff1 F)))
...
(assert (= (ff.mul v547 v582) (as ff1 F)))
