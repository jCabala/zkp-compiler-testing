...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0881--prune3--seed50.smt2
; backend=circom
...
(assert (= (ff.mul v185 v190) (as ff1 F)))
(assert (= (ff.mul v3 v640) (as ff1 F)))
...
(assert (= (ff.mul v1078 v1083) (as ff1 F)))
