...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0677--prune3--seed50.smt2
; backend=circom
...
(assert (= (ff.mul v14 v22) (as ff1 F)))
...
(assert (= (ff.mul v3 v526) (as ff1 F)))
...
(assert (= (ff.mul v883 v913) (as ff1 F)))
