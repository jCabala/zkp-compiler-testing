...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0333--prune3--seed48.smt2
; backend=circom
...
(assert (= (ff.mul v2 v680) (as ff1 F)))
...
(assert (= (ff.mul v1141 v1149) (as ff1 F)))
