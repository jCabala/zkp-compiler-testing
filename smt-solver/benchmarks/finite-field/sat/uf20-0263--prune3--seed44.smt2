...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0263--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v684 v715) (as ff1 F)))
...
(assert (= (ff.mul v3 v779) (as ff1 F)))
