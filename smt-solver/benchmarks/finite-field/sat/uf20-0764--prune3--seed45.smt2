...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0764--prune3--seed45.smt2
; backend=circom
...
(assert (= (ff.mul v192 v200) (as ff1 F)))
...
(assert (= (ff.mul v227 v232) (as ff1 F)))
