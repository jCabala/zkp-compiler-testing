...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0370--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v15 v23) (as ff1 F)))
...
(assert (= (ff.mul v622 v630) (as ff1 F)))
