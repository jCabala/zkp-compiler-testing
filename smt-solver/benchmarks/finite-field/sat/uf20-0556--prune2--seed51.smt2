...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0556--prune2--seed51.smt2
; backend=circom
...
(assert (= (ff.mul v677 v682) (as ff1 F)))
(assert (= (ff.mul v1 v1133) (as ff1 F)))
