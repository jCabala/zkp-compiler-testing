...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0622--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v1221 v1229) (as ff1 F)))
...
(assert (= (ff.mul v1234 v1244) (as ff1 F)))
