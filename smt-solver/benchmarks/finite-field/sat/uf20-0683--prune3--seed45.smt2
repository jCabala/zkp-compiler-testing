...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0683--prune3--seed45.smt2
; backend=circom
...
(assert (= (ff.mul v807 v812) (as ff1 F)))
(assert (= (ff.mul v3 v1033) (as ff1 F)))
(assert (= (ff.mul v3 v1046) (as ff1 F)))
