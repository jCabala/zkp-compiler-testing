...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-095--prune2--seed46.smt2
; backend=circom
...
(assert (= (ff.mul v1 v777) (as ff1 F)))
...
(assert (= (ff.mul v787 v792) (as ff1 F)))
(assert (= (ff.mul v1 v897) (as ff1 F)))
