...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0812--prune3--seed48.smt2
; backend=circom
...
(assert (= (ff.mul v1 v474) (as ff1 F)))
...
(assert (= (ff.mul v1201 v1258) (as ff1 F)))
