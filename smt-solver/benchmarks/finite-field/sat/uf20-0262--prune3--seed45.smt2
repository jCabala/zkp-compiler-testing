...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0262--prune3--seed45.smt2
; backend=circom
...
(assert (= (ff.mul v3 v847) (as ff1 F)))
...
(assert (= (ff.mul v892 v897) (as ff1 F)))
