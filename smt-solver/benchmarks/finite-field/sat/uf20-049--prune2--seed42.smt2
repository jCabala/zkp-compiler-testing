...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-049--prune2--seed42.smt2
; backend=circom
...
(assert (= (ff.mul v500 v505) (as ff1 F)))
(assert (= (ff.mul v2 v571) (as ff1 F)))
(assert (= (ff.mul v2 v694) (as ff1 F)))
