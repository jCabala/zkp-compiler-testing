...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0902--prune3--seed45.smt2
; backend=circom
...
(assert (= (ff.mul v389 v394) (as ff1 F)))
...
(assert (= (ff.mul v3 v708) (as ff1 F)))
