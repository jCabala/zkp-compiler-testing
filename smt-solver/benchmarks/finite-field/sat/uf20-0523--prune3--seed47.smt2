...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0523--prune3--seed47.smt2
; backend=circom
...
(assert (= (ff.mul v115 v120) (as ff1 F)))
...
(assert (= (ff.mul v2 v3) (ff.add v2 v3 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v586))))
...
(assert (= (ff.mul v629 v637) (as ff1 F)))
