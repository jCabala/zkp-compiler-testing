...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0214--prune3--seed47.smt2
; backend=circom
...
(assert (= (ff.mul v3 v1) (ff.add v1 v3 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v396))))
(assert (= (ff.mul v396 v401) (as ff1 F)))
(assert (= (ff.mul v3 v545) (as ff1 F)))
(assert (= (ff.mul v3 v750) (as ff1 F)))
