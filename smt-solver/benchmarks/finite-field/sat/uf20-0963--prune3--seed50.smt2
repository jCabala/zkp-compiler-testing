...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0963--prune3--seed50.smt2
; backend=circom
...
(assert (= (ff.mul v613 v618) (as ff1 F)))
...
(assert (= (ff.mul v1 v1011) (as ff1 F)))
