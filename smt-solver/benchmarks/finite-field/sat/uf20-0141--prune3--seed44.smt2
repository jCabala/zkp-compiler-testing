...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0141--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v440 v445) (as ff1 F)))
...
(assert (= (ff.mul v896 v901) (as ff1 F)))
...
(assert (= (ff.mul v3 v1) (ff.add v1 v3 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v1012))))
