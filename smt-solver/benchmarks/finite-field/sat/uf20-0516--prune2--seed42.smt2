...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0516--prune2--seed42.smt2
; backend=circom
...
(assert (= (ff.mul v1 v579) (as ff1 F)))
...
(assert (= (ff.mul v857 v862) (as ff1 F)))
