...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0522--prune3--seed45.smt2
; backend=circom
...
(assert (= (ff.mul v992 v1002) (as ff1 F)))
(assert (= (ff.mul v3 v2) (ff.add v2 v3 (ff.mul (as ff21888242871839275222246405745257275088548364400416034343698204186575808495616 F) v1104))))
(assert (= (ff.mul v1104 v1114) (as ff1 F)))
