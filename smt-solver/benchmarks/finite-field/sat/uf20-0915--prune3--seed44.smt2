...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0915--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v61 v73) (as ff1 F)))
...
(assert (= (ff.mul v1152 v1165) (as ff1 F)))
