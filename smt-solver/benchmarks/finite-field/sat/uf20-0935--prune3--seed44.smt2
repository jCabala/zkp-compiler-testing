...
; source=/home/jcabala/fyp/new_repos/zkp_testing/smt-solver/benchmarks/core/sat/uf20-0935--prune3--seed44.smt2
; backend=circom
...
(assert (= (ff.mul v251 v261) (as ff1 F)))
...
(assert (= (ff.mul v834 v844) (as ff1 F)))
