...
(assert (let ((arc_r0_s0 (ff.add x0 (as ff21757736813606664824945916625031809753475731382308924690421424576288720388142 F))))
...
(and (= mds_r0_s0 (as ff8391175893967859506906677189138323944636311195098904405333436019805617532200 F)))))))
